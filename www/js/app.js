var WatchStock = React.createClass({
    ...
    render: function () {
        return (
            <div className="row">
                <p>Available stocks for demo: ASIANPAINT, BAJAJFIN, DMART, EXIDEIND ,IEX, IRCTC, KOTAKBANK, LICI, MSUMI, TCS</p>
...
var HomePage = React.createClass({
    getInitialState: function() {
        var stocks = {};
        feed.watch(['ASIANPAINT', 'BAJAJFIN', 'DMART', 'EXIDEIND', 'IEX', 'IRCTC', 'KOTAKBANK', 'LICI', 'MSUMI', 'TCS']);
